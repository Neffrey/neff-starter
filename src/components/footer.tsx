...
const Footer = () => {
  return (
    <div
      // Row Container
      className="flex w-full items-center justify-center border-t-4 border-solid border-secondary-foreground bg-gradient-to-r from-secondary to-muted px-5 py-6 shadow-xl"
    >
